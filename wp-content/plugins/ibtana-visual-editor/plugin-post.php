  ...
  class Ibtana_visual_editor_pro_postControl{
    ...
    */
    ...
    function post_slider_layout_render_post_grid($attributes){
      ...
      $mobCartButton = $attributes['cartButton'][0] == 'true' ?  'none' : 'flex';
      $tabCartButton = $attributes['cartButton'][1] == 'true' ?  'none' : 'flex';
      $deskCartButton = $attributes['cartButton'][2] == 'true' ?  'none' : 'flex';
      $mobdispPostTitle = $attributes['displayPostTitle'][0] == 'true' ?  'none' : 'block';
      $tabdispPostTitle = $attributes['displayPostTitle'][1] == 'true' ?  'none' : 'block';
      $deskdispPostTitle = $attributes['displayPostTitle'][2] == 'true' ?  'none' : 'block';

      $mobdispPostContent = $attributes['displayPostExcerpt'][0] == 'true' ?  'none' : 'block';
      $tabdispPostContent = $attributes['displayPostExcerpt'][1] == 'true' ?  'none' : 'block';
      $deskdispPostContent = $attributes['displayPostExcerpt'][2] == 'true' ?  'none' : 'block';

      $mobdispProductContent = $attributes['displayProductExcerpt'][0] == 'true' ?  'none' : 'block';
      $tabdispProductContent = $attributes['displayProductExcerpt'][1] == 'true' ?  'none' : 'block';
      $deskdispProductContent = $attributes['displayProductExcerpt'][2] == 'true' ?  'none' : 'block';

      $mobdispPostBtn = $attributes['displayPostReadMoreButton'][0] == 'true' ?  'none' : 'inline-block';
      $tabdispPostBtn = $attributes['displayPostReadMoreButton'][1] == 'true' ?  'none' : 'inline-block';
      $deskdispPostBtn = $attributes['displayPostReadMoreButton'][2] == 'true' ?  'none' : 'inline-block';

      $mobdispPostImg = $attributes['displayPostImage'][0] == 'true' ?  'none' : 'block';
      $tabdispPostImg = $attributes['displayPostImage'][1] == 'true' ?  'none' : 'block';
      $deskdispPostImg = $attributes['displayPostImage'][2] == 'true' ?  'none' : 'block';

      $mobdispPostImgDate = $attributes['imageDateOption'][0] == 'true' ?  'none' : 'block';
      $tabdispPostImgDate = $attributes['imageDateOption'][1] == 'true' ?  'none' : 'block';
      $deskdispPostImgDate = $attributes['imageDateOption'][2] == 'true' ?  'none' : 'block';

      $mobdispPostAuth = $attributes['displayPostAuthor'][0] == 'true' ?  'none' : 'block';
      $tabdispPostAuth = $attributes['displayPostAuthor'][1] == 'true' ?  'none' : 'block';
      $deskdispPostAuth = $attributes['displayPostAuthor'][2] == 'true' ?  'none' : 'block';
      $mobdispPostAuthIcon = $attributes['displayPostAuthorIcon'][0] == 'true' ?  'none' : 'inline-block';
      $tabdispPostAuthIcon = $attributes['displayPostAuthorIcon'][1] == 'true' ?  'none' : 'inline-block';
      $deskdispPostAuthIcon = $attributes['displayPostAuthorIcon'][2] == 'true' ?  'none' : 'inline-block';

      $mobdispPostDate = $attributes['displayPostDate'][0] == 'true' ?  'none' : 'block';
      $tabdispPostDate = $attributes['displayPostDate'][1] == 'true' ?  'none' : 'block';
      $deskdispPostDate = $attributes['displayPostDate'][2] == 'true' ?  'none' : 'block';
      $mobdispPostDateIcon = $attributes['displayPostDateIcon'][0] == 'true' ?  'none' : 'inline-block';
      $tabdispPostDateIcon = $attributes['displayPostDateIcon'][1] == 'true' ?  'none' : 'inline-block';
      $deskdispPostDateIcon = $attributes['displayPostDateIcon'][2] == 'true' ?  'none' : 'inline-block';

      $mobdispPostComment = $attributes['displayComment'][0] == 'true' ?  'none' : 'block';
      $tabdispPostComment = $attributes['displayComment'][1] == 'true' ?  'none' : 'block';
      $deskdispPostComment = $attributes['displayComment'][2] == 'true' ?  'none' : 'block';
      $mobdispPostCommentIcon = $attributes['displayCommentIcon'][0] == 'true' ?  'none' : 'inline-block';
      $tabdispPostCommentIcon = $attributes['displayCommentIcon'][1] == 'true' ?  'none' : 'inline-block';
      $deskdispPostCommentIcon = $attributes['displayCommentIcon'][2] == 'true' ?  'none' : 'inline-block';
      ...
      $markup .= '<style>
        ...
        .ibtana_cart_button_'.$uniqueID.'{
          ...
          color: '.$attributes['cartTextColor'].' !important;
          border-radius: '.$attributes['cartBorderRadius'].'px !important;
          border-color: '.$attributes['cartBorderColor'].' !important;
          font-family:'.$attributes['typography'].' ;
          font-weight: '.$attributes['fontWeight'].';
          font-style: '.$attributes['fontStyle'].';
          border-style: '.$attributes['borderType'].';
          border-width: '.$attributes['cartBorderWidth'].'px !important;
        }
      ...
      .ive-product-slider-parent'.$uniqueID.' .star-rating::before {
        ...
        @media screen and (max-width: 767px){
          ...
          #ive-posttype-carousel'.$uniqueID.' .owl-nav button span {
